...
seal2 = rs.SealElement(n=4, kxx=stfx, kyy=stfy, cxx=1e3, cyy=0.8e3)
seal3 = rs.SealElement(n=39, kxx=stfx, kyy=stfy, cxx=1e1, cyy=0.8e1)


#Bearing location: 13,31
#Seal Location:2,4,39
