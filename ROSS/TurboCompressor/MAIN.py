...
deform.show()
deform.write_html("./output/deform_pic.html")
freebody = static.plot_free_body_diagram()
freebody.show()
freebody.write_html("./output/freebody_pic.html")


#1.2.Modal Analysis=========================================================
rotor_speed = 16500.0 # rad/s
...
#1.3 Campbell Plot===========================================================
samples = 30
speed_range = np.linspace(0, 16500, samples)
