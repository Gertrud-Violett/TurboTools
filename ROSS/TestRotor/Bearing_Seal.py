...
stfx = 1e6
stfy = 0.8e6
bearing0 = rs.BearingElement(n=0, kxx=stfx, kyy=stfy, cxx=0, n_link=9)
bearing1 = rs.BearingElement(n=8, kxx=stfx, kyy=stfy, cxx=0)
bearing2 = rs.BearingElement(n=9, kxx=stfx, kyy=stfy, cxx=0)

bearings = [bearing0, bearing1, bearing2]

#BEARING CHECK==============================================================
#Check Bearing specs========================================================
#bearing_fig=bearing5.kxx.plot() #Enter any bearing no and attribute
#bearing_fig.show()
...
stfx = 1e6
stfy = 0.8e6
seal1 = rs.SealElement(n=0, kxx=stfx, kyy=stfy, cxx=1e3, cyy=0.8e3)
