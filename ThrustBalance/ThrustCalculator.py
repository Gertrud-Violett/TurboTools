...
#Read and create pd
name, C_Spec, T_Spec, csvfile, pressure,TipOp,Shroud= readset("./input/settings.ini")
res_df = csv_df("./input/"+csvfile)
...
df.to_csv('./output/' + name + '_res.csv')
with open('./output/' + name + 'geom.json', 'w') as fp:
    json.dump(outdata, fp, indent=4, sort_keys=True, separators=(',', ': '))
...
plt.xlabel('rpm')
plt.savefig('./output/' + name + '_RPM-Pressure.png')
#plt.show()
...
plt.ylabel('Pressure [kPaA]')
plt.xlabel('Time[s]')
plt.savefig('./output/' + name + '_Time-Pressure.png')
#plt.show()
...
plt.ylabel('Thrust [N]')
plt.xlabel('rpm')
plt.savefig('./output/' + name + '_RPM-Thrust.png')
#plt.show()
...
plt.ylabel('Thrust [N]')
plt.xlabel('Time[s]')
plt.savefig('./output/' + name + '_Time-Thrust.png')
#plt.show()
...
plt.xlabel('Time[s]')
plt.savefig('./output/' + name + '_Time-OilPres.png')
#plt.show()
...
plt.xlabel('Time[s]')
plt.savefig('./output/' + name + '_Time-OilTemp.png')
#plt.show()
...
plt.ylabel('Oil Temp [degC]')
plt.xlabel('Time[s]')
plt.savefig('./output/' + name + '_Time-GasTemp.png')
#plt.show()